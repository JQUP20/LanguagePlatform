...
void NoteViewPane::InitCtrl()
{
    ...
    IconHelper::SetIcon(m_btnMin, QChar(0xe8f2), 10);
    IconHelper::SetIcon(m_btnMax, QChar(0xe65b), 10);
    IconHelper::SetIcon(m_btnClose, QChar(0xe837), 10);
    IconHelper::SetIcon(m_btnAbout, QChar(0xe8c4), 10);
